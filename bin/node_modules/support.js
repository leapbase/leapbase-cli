...
exports.isLeapbaseFolder = async function(path) {
  ...
  if (!existsSync(`bin/create_extension_symlinks`)) {
    return false;
  }
  return true;
};
...
exports.mergeExtensionResource = async function(leapbaseFolder, extensionFolder) {
  console.log('>>> mergeExtensionResource:', leapbaseFolder, extensionFolder);
...
exports.addExtension = async function(extensionName, downloadUrl) {
  ...
  await exports.mergeExtensionResource(leapbaseFolder, extensionFolder);
