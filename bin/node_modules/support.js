...
exports.mergeExtensionResource = async function(extensionFolder) {
  console.log('>>> mergeExtensionResource:', extensionFolder);
  let extensionResContent = fs.readFileSync(`${extensionFolder}/package.json`);
  let extensionRes = JSON.parse(extensionResContent);
  let leapbaseResContent = fs.readFileSync(`./package.json`);
  let leapbaseRes = JSON.parse(leapbaseResContent);
  
  console.log('>>> extensionRes:', JSON.stringify(extensionRes, null, 2));
  console.log('>>> leapbaseRes:', JSON.stringify(leapbaseRes, null, 2));
